...
public class UsuarioServlet extends HttpServlet {
    ...
    private void listarUsuario(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Usuario> listarUsuario = usuarioDAO.selecionarUsuarios();
    ...
    private void inserirUsuario(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario adicaoUsuario = new Usuario(nome, email, pais, endereco, modalidade);
    ...
    private void atualizarUsuario(HttpServletRequest request, HttpServletResponse response)
        ...
        String endereco = request.getParameter("endereco");
        String modalidade = request.getParameter("modalidade");
        Usuario atualizacaoUsuario = new Usuario(codigo, nome, email, pais, endereco, modalidade);
